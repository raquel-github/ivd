...
for epoch in range(iterations):
    ...
    writer.add_scalar("Training/Epoch Precision No", oracle_epoch_precisions[-1][0], epoch)
    writer.add_scalar("Training/Epoch Precision Yes", oracle_epoch_precisions[-1][1], epoch)
    writer.add_scalar("Training/Epoch Precision N/A", oracle_epoch_precisions[-1][2], epoch)
    writer.add_scalar("Training/Epoch Recall No", oracle_epoch_recalls[-1][0], epoch)
    writer.add_scalar("Training/Epoch Recall Yes", oracle_epoch_recalls[-1][1], epoch)
    writer.add_scalar("Training/Epoch Recall N/A", oracle_epoch_recalls[-1][2], epoch)
    writer.add_scalar("Training/Epoch F1 No", oracle_epoch_f1s[-1][0], epoch)
    writer.add_scalar("Training/Epoch F1 Yes", oracle_epoch_f1s[-1][1], epoch)
    writer.add_scalar("Training/Epoch F1 N/A", oracle_epoch_f1s[-1][2], epoch)
    ...
    writer.add_scalar("Validation/Epoch Precision No", oracle_val_precisions[-1][0], epoch)
    writer.add_scalar("Validation/Epoch Precision Yes", oracle_val_precisions[-1][1], epoch)
    writer.add_scalar("Validation/Epoch Precision N/A", oracle_val_precisions[-1][2], epoch)
    writer.add_scalar("Validation/Epoch Recall No", oracle_val_recalls[-1][0], epoch)
    writer.add_scalar("Validation/Epoch Recall Yes", oracle_val_recalls[-1][1], epoch)
    writer.add_scalar("Validation/Epoch Recall N/A", oracle_val_recalls[-1][2], epoch)
    writer.add_scalar("Validation/Epoch F1 No", oracle_val_f1s[-1][0], epoch)
    writer.add_scalar("Validation/Epoch F1 Yes", oracle_val_f1s[-1][1], epoch)
    writer.add_scalar("Validation/Epoch F1 N/A", oracle_val_f1s[-1][2], epoch)
