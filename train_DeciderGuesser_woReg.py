...
output_file             = "logs/deciderguesser_output_woReg" + ts + ".log"
loss_file               = "logs/decider_guesser_loss_woReg" + ts + ".log"
hyperparameters_file    = "logs/deciderguesser_hyperparameters_woReg" + ts + ".log"
...
guesser_model_path		= 'ivdModels/bin/guessermodel_woReg'+ts+'_e'
decider_model_path		= 'ivdModels/bin/decidermodel_woReg'+ts+'_e'
